...
public class InsuranceInputValidatorTests
{
    ...
    {
        var input = new InsuranceInput(Guid.NewGuid(), "123456", "", DateTime.Today, DateTime.Today.AddDays(1));
    ...
    {
        var input = new InsuranceInput(Guid.NewGuid(), "123456", "Car", DateTime.Today.AddDays(2), DateTime.Today);
        var result = _validator.Validate(input);
        Assert.False(result.IsValid);
    ...
    {
        var input = new InsuranceInput(Guid.NewGuid(), "123456", "Car", DateTime.Today, DateTime.Today.AddDays(1));
        var result = _validator.Validate(input);
